...
use frame_support::{
    traits::Currency,
    weights::{
        constants::ExtrinsicBaseWeight, DispatchClass, DispatchInfo, GetDispatchInfo,
        ...
        let events = vec![
            EventRecord {
                ...
                event: Event::frame_system(frame_system::RawEvent::ExtrinsicSuccess(
                    DispatchInfo {
                        weight: 8_000_000 + 2 * 25_000_000 + 1 * 100_000_000,
            ...
            EventRecord {
                ...
                event: Event::frame_system(frame_system::RawEvent::ExtrinsicSuccess(
                    DispatchInfo {
                        weight: 70_000_000 + 25_000_000 + 100_000_000,
                        ..Default::default()
                    },
                )),
                topics: vec![],
